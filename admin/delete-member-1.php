...
<?php 
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if($query2===TRUE){
			header('location: search-members.php?msg='.urlencode(base64_encode("<span class='error'>Delete successfull.</span><br><br>")));
		}else{
	...
	<div class="col-md-9">
		<div class="panel">
			...
			<form action="" method="POST" name="deldataform">
				<input type="submit" name="deletedata" value="Delete" class="btn btn-danger"> <a class="btn btn-primary" href="search-members.php">Cancel</a>
			</form>	
